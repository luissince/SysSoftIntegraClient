            ...
            <div class="tile mb-4">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <button class="btn btn-secondary" id="btnLimpiar"><i class="fa fa-paint-brush"></i> Limpiar</button>
                            <button class="btn btn-secondary" id="btnProveedor"><i class="fa fa-address-book"></i> Proveedores</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <label><img src="./images/providers.png" width="22" height="22"> Proveedor:</label>
                        <div class="form-group">
                            <input class="form-control" type="search" placeholder="Buscar" id="txtBuscarProveedor">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <label><img src="./images/inventario.png" width="22" height="22"> Almacen:</label>
                        <div class="form-group">
                            <select class="select2-selection__rendered form-control" id="cbAlmacen">
                            </select>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="form-group">
                            <div class="d-flex">
                                <input class="form-control mr-1" type="text" id="txtSerie" placeholder="Serie">
                                <input class="form-control ml-1" type="text" id="txtNumeracion"  placeholder="Numeracion">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <label><img src="./images/asignacion.png" width="22" height="22"> Notas:</label>
                            <input class="form-control" type="text" id="txtNota" placeholder="Ingrese alguna Nota">
                        </div>
                    </div>
