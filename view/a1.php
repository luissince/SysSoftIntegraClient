                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="tile border-0 p-0">
                                <div class="overlay p-5" id="divOverlayBanco">
                                    <div class="m-loader mr-4">
                                        <svg class="m-circular" viewBox="25 25 50 50">
                                            <circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="4" stroke-miterlimit="10"></circle>
                                        </svg>
                                    </div>
                                    <h4 class="l-text text-center text-white p-10" id="lblTextOverlayBanco">Cargando información...</h4>
                                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="table-responsive">
                            <table class="table table-striped" style="border-width: 1px;border-style: dashed;border-color: #007bff;">
                                ...
                                <tbody id="tbList">
                                    <tr>
                                        <td colspan="9" class="text-center">!Aún no has registrado ningún banco¡</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
