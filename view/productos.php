                    ...
                    <div class="tile">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    <input id="rbMarca" type="checkbox" checked>
                                    <label for="rbMarca">Todas</label>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <label>Marca</label>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    <input id="rbCategoria" type="checkbox" checked>
                                    <label for="rbCategoria">Todas</label>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    <input id="rbPresentacion" type="checkbox" checked>
                                    <label for="rbPresentacion">Todas</label>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    <input id="rbUnidadMedida" type="checkbox" checked>
                                    <label for="rbUnidadMedida">Todas</label>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        ...
        <div class="tile">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Clave o clave alterna"
                            class="input-primary " id="txtClaveProducto">
                    </div>
                </div>
                <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Descripción del producto"
                            class="input-primary" id="txtDescripcionProducto">
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="table-responsive">
                        <table class="table table-striped"
                            style="border-width: 1px;border-style: dashed;border-color: #007bff;">
    ...
    $(document).ready(function() {
        ...
        $("#modalCatalogo").on('shown.bs.modal', async function(e) {
            ...
            try{
                ...
                $("#lblTextOverlayCatalogo").html(error.responseText);
            }
        });

        $("#rbMarca").change(function () {
            $("#cbSelectMarca").prop('disabled', $("#rbMarca").is(":checked"));

        });

        $("#rbCategoria").change(function () {
            $("#cbSelectCategoria").prop('disabled', $("#rbCategoria").is(":checked"));

        });

        $("#rbPresentacion").change(function () {
            $("#cbSelectPresentacion").prop('disabled', $("#rbPresentacion").is(":checked"));

        });

        $("#rbUnidadMedida").change(function () {
            $("#cbSelectUnidadMedida").prop('disabled', $("#rbUnidadMedida").is(":checked"));
