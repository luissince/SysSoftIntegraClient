...
if (is_array($notaCreditoDatos)) {
    ...
    $textoCodBar =
        ...
        . '|' . $notacredito->CodigoAlterno
        . '|' . $notacredito->SerieNotaCredito
        . '|' . $notacredito->NumeracioNotaCredito
        . '|' . number_format(round($notacredito->Total, 2, PHP_ROUND_HALF_UP), 2, '.', '')
        . '|' . number_format(round($notacredito->Impuesto, 2, PHP_ROUND_HALF_UP), 2, '.', '')
        . '|' . $notacredito->FechaRegistro
        . '|' . $notacredito->IdAuxiliar
        ...
        <body>
            ...
            <div class="cont-header">
                ...
                <div class="caja-info-dos">
                    ...
                    <p style="line-height: 35px;">' . $notacredito->NotaCreditoComprobante . '</p>
                    <p style="line-height: 35px;">' . $notacredito->SerieNotaCredito . '-' . $notacredito->NumeracioNotaCredito . '</p>         
                </div>
            </div>
            <!--#########################Fin de la cabecera###################################-->
            ...
            <div class="container-info">
                ...
                <table  style="font-family: arial; font-size:8pt;color:white; border-collapse: collapse; width:100%">
                    <tr>
                        ...
                        <td colspan="3" style="background: white;border: 1px solid black; color: black; width:65%;padding:6px;"><p>' . $notacredito->NumeroDocumento . '</p></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="width:27%; border: 1px solid black; color: black;padding:6px;"><p>' . $notacredito->Informacion . '</p></td>
                        <td style="width:20%; border-right: 1px solid black; color: black; text-align:center;border: 1px solid black;padding:6px;"><p>' . $notacredito->FechaRegistro . '</p></td>
                    </tr>    
                    <tr>
                        <td style=" background: rgb(2,2,3);border: 1px solid black;padding:6px;"><p>Dirección:</p></td>
                        <td colspan="3" style=" width:65%; color: black;border: 1px solid black;padding:6px;"><p>' . $notacredito->Direccion . '</p></td>                        
                    ...
                    <tr>
                        ...
                        <td style="color: black;border: 1px solid black;padding:6px;;"><p>' . $notacredito->Celular . '  ' . $notacredito->Telefono . '</p></td>
...
?>
                    ...
                    foreach ($detallenotacredito as $value) {
                        ...
                        <td style="text-align: left;font-size: 7pt;">' . $value["Unidad"] . '</td>
                        <td style="text-align: left;font-size: 7pt;">' . $value["NombreMarca"] . '</td>
                        <td style="text-align: right;font-size: 7pt;">' . number_format(round($value["Precio"], 2, PHP_ROUND_HALF_UP), 2, '.', '') . '</td>
                        <td style="text-align: right;font-size: 7pt;">' . number_format(round($value["Importe"], 2, PHP_ROUND_HALF_UP), 2, '.', '') . '</td>
                        </tr>';
                    }
                    ?>
                    <?php
